function [recap_results, fval] = minimize_with_gsbx_genetic_algorithm(fmin, n, npop, rate_mut, rate_cross, maxiter, lb, ub, epsilon)
    ...
    for j=1:maxiter
       ...
       for c=1:number_cross
           ...
           ww=gsbx_cross(popall(r1).pos,popall(r2).pos, grads_r1', grads_r2');
