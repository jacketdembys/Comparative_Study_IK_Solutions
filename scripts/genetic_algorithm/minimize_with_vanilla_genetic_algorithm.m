function [recap_results, fval] = minimize_with_vanilla_genetic_algorithm(fmin, n, npop, rate_mut, rate_cross, maxiter, lb, ub)
        ...
        for j=1:maxiter
           ...
           % Here the selection is to the size of the population npop, 
           % So, specific selection procedure is implemented
           ...
           for c=1:number_cross
               % Here the parents for crossover are randomly selected among
               % the population
               t=randperm(npop);
               r1=t(1);
               r2=t(2);
