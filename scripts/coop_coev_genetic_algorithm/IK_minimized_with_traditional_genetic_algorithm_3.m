function [out] = IK_minimized_with_traditional_genetic_algorithm_3(problem, params)
...
%             popAll = pop(1:nPop);
            for num=1:nPop
                ...
                k_way = 20;
                indices = randperm(length(pop));
                indices = indices(1:k_way);
                
                mid_pop = pop(indices);
                
                sorted_mid_pop = SortPopulation(mid_pop);
                
                popAll(num) = sorted_mid_pop(1);
